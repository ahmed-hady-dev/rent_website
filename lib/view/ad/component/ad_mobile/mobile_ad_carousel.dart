...
class MobileAdCarousel extends StatefulWidget {
  const MobileAdCarousel({
    super.key,
  });

  @override
  State<MobileAdCarousel> createState() => _MobileAdCarouselState();
}

class _MobileAdCarouselState extends State<MobileAdCarousel> {
