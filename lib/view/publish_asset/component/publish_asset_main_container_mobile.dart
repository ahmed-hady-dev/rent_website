...
class PublishAssetMainContainerMobile extends StatefulWidget {
  ...
  @override
  State<PublishAssetMainContainerMobile> createState() => _PublishAssetMainContainerMobileState();
}

class _PublishAssetMainContainerMobileState extends State<PublishAssetMainContainerMobile> {
  String _radioValue = '';
  navigateToAssetAd() {
    if (_radioValue == 'free') {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.symmetric(horizontal: widget.hPaddingMobile),
      ...
      child: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: const Text('اعرض عقارك وقم بمتابعة كل شئ اول باول',
                style: TextStyle(
                  fontSize: 18.0,
                  color: Colors.black,
          ...
          Gap(widget.height * 0.012),
          Padding(
            padding: EdgeInsetsDirectional.only(start: widget.width * 0.03, end: widget.width * 0.03),
            child: SizedBox(
              width: widget.width,
